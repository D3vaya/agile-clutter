...
<Canvas>
  <Story name="Colores">
    <Avatar color={Colors.red} />
    <Avatar color={Colors.purple} />
    <Avatar color={Colors.blue} />
    <Avatar color={Colors.cyan} />
    <Avatar color={Colors.amber} />
    <Avatar color={Colors.lime} />
    <Avatar color={Colors.green} />
    <Avatar color={Colors.smerald} />
    <Avatar color={Colors.orange} />
    <Avatar color={Colors.sky} />
    <Avatar color={Colors.teal} />
  </Story>
</Canvas>
